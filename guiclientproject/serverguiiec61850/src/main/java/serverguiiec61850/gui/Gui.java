...
public class Gui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        createDatasetRefTB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                createDatasetRefTBActionPerformed(evt);
            }
        });
        ...
        simulatePulsMaxTB.setText("100");

        simulatePulsTimeOffTB.setText("1");

        simulatePulsTimeOnTB.setText("10000");
...
//ToDo Error report
        ...
        try {
            ...
            if (exists) {
                ...
                try {
                    ...
                    LOGGER_GUI.error("theres already a file in files/icd\n");
                }
            }
            Files.copy(copySourcePath, copyTargetPath);
            serverguiiec61850.files.ModifyXmlFile.splitIed();
        } catch (IOException ex) {
            LOGGER_GUI.error("error while opening file", ex);
        } catch (TransformerConfigurationException ex) {
            LOGGER_GUI.error("error while split icd/scl", ex);
    ...
    private void simulateRampStartBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simulateRampStartBTNActionPerformed
        ...
        try {
            ...
            time = Integer.parseInt(simulateRampTimeTB.getText());
            ...
            steps = 0;
            //ToDo warning
            LOGGER_GUI.error("a non number in ramp simulator", e);
        }
        ...
        LOGGER_GUI.info("ramp simulator stopped\n");
    ...
    private void simulatePulsStartBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simulatePulsStartBTNActionPerformed
        ...
        int OnTime;
        try {
            OffTime = Integer.parseInt(simulatePulsTimeOffTB.getText());
            OnTime = Integer.parseInt(simulatePulsTimeOnTB.getText());
        } catch (NumberFormatException e) {
    ...
    private void createDatasetRefTBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createDatasetRefTBActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_createDatasetRefTBActionPerformed
